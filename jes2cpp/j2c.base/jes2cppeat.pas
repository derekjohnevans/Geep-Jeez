...
function EatUntil(const AString: String; var APos: Integer; out AResult: String; const ACharSet: TSysCharSet; const ATrim: Boolean = True): Char;
  overload;
function EatUntil(const AString: String; var APos: Integer; out AResult: Extended; const ACharSet: TSysCharSet;
...
begin
  LPos := APos;
  Result := EatUntil(AString, APos, LStr, ACharSet, ATrim);
